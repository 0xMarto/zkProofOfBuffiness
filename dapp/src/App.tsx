...
class App extends React.Component<MyProps, MyState> {
    ...
    async _signMessage() {
        ...
        try {
            ...
            // TODO Figured this out tomorrow
            // Generating ZK Proof
            // const buffi_inputs = {'a': 1};
            // const circuit = "./public/zkLibs/buffi_js/buffi.wasm"
            // const circuit_key = "circuit_final.zkey"
            // const { proof, buffi_outputs } = await snarkjs.plonk.fullProve(buffi_inputs, circuit, circuit_key);
            // console.log('Proof:', proof);
            // console.log('buffi_outputs:', buffi_outputs);
